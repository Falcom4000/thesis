...
\hkustsetup {
  ...
  info = {
    ...
    title         = {FasterGSFusedRapid:\texorpdfstring{\\}{ }Fast 3D Gaussian Splatting Training with Fused Backend, Multi-View Structure Control, and Compact Rasterization},
    % keywords      = {Neon, Genesis, Evangelion},
    author        = {Cruel Angel},
    % school        = {School of SEELE},
    department    = {Department of NERV},
    program       = {Human Instrumentality},  % Check it on SIS
    % major         = {},
    supervisor    = {Prof. Adams},
    co-supervisor = {Prof. Lilith},    % comment this line if NA
    ...
    %% reviewer info is only required by certain departments like ECE
...
\input{chapters/Ch_ProblemFormulation.tex}
\input{chapters/Ch_Method.tex}
\input{chapters/Ch_Implementation.tex}
\input{chapters/Ch_Experiments.tex}
